    ...
    <AnimatePresence>
      {open && data && (
        <>
          ...
          >
            <div className="w-full max-w-3xl rounded-2xl border border-neutral-800 bg-neutral-950 p-6 md:p-8 relative shadow-[0_10px_30px_-12px_rgba(0,0,0,0.5)]">
              <button
                onClick={onClose}
                className="absolute right-3 top-3 rounded-lg text-neutral-400 hover:text-white"
              ...
              <p className="mt-1 text-neutral-300">{data.summary}</p>
              <div className="mt-2 text-neutral-400">{data.timeline}</div>
